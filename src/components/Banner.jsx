  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      <h1 className="text-5xl font-bold text-primary mb-3">
        Kerko per nje pune <span className="text-blue">te re</span> sot
      </h1>
      <p className="text-lg text-black/70 mb-8">
        Mijera vende pune ne sektoret e kompjuterave, inxhinierise dhe
        teknologjise jane duke pritur per ju
      </p>
        ...
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          <div className="flex md:rounded-s-md rounded shadow-sm right-1 ring-inset  focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full">
            <input
              ...
              name="title"
              id="title"
              placeholder="Cfare pozicioni pune jeni duke kerkuar ?"
          ...
          <button type="submit" className="bg-blue py-2 px-8 text-white md:rounded-s-none rounded">Kerko</button>
        </div>
      </form>
    </div>
  );
