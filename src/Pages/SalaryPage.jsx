...
const SalaryPage = () => {
    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      <PageHeader title={"Estimate Salary"} path={"Paga"}/>
      ...
      <div className='mt-5'>
        <div className='search-box p-2 text-center mb-2'> 
            ...
            <button onClick={handleSearch} className='bg-blue text-white font-semibold px-8 py-2 rounded-sm mb-4'>Kerko</button>
        </div>
